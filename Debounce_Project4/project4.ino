/*
   ...
   By Maggie Storino
   This sketch is based on the GWC campus code and 
   creates a Motion sensing sock using the LilyPad Arduino SimpleSnap.
   It uses conditionals, operators, and custom functions. 
   It also integrates debouncing
   to make sure the tilt switch is actually tilted and not just experiencing noise.
   This code is based on GWC's Project 4 code https://github.com/lizastark/GWC_WearableTech/blob/master/Day_Four/PROJECT/MotionChangerExample/MotionChangerExample.ino
   and the "Better Debouncer" example by Lady Ada that you can find here:
